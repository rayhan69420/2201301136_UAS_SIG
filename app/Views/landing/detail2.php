                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="detail-box text-center">
                                    <h1>Detail informasi geografis Kantor Bupati</h1>
                                </div>
                            </div>
                        </div>
                    </div>
...
<!-- Include jQuery, Bootstrap, and Google Maps API -->
...
<script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyCh39n5U-4IoWpsVGUHWdqB6puEkhRLdmI&callback=initMap">
</script>
